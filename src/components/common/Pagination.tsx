  ...
  return (
    <div className="flex items-center justify-center gap-5 mt-5 w-fit">
      ...
      <Button
        ...
        className={`flex items-center gap-1 px-4 py-2 rounded-xl text-sm font-medium transition ${currentPage === totalPages
          ? "bg-gray-200 text-gray-400 cursor-not-allowed"
          : "bg-blue-600 text-white hover:bg-blue-700"
          }`}
      >
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          className="border border-gray-300 focus:outline-none rounded-lg px-2 py-1 text-sm"
        >
